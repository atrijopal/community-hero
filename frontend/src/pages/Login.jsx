    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Community Hero</h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 px-4 text-gray-700 font-medium hover:border-blue-300 hover:bg-blue-50 transition mb-6"
        >
          ...
          Continue with Google (Citizens)
        </button>

        <div className="relative mb-6">
          <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200" /></div>
          <div className="relative text-center"><span className="bg-white px-4 text-sm text-gray-500">Officer / Admin login</span></div>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-xl text-xs text-gray-600">
          ...
          <p>Citizen: Use Google Sign-In</p>
        </div>
      </div>
    </div>
  );
